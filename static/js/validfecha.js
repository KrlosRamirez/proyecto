...
function Edad() {
  ...
  if( edad <= 1 || edad >= 100 ) {
    $('#id_btn_form1').attr('disabled', 'disabled')
    $('#id_form1').attr('disabled', 'disabled')
    $('#alertaDos').removeClass('hide');
    ...
    $('#id_btn_form1').removeAttr('disabled')
    $('#id_form1').removeAttr('disabled')
    $('#alertaDos').addClass('hide');
